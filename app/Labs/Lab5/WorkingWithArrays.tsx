...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <FormControl id="wd-remove-todo-id" defaultValue={todo.id} className="w-50"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/><hr/>
      <h4>Updating an Item in an Array</h4>
      <a href={`${API}/${todo.id}/title/${encodeURIComponent(todo.title)}`} className="btn btn-primary float-end">
        Update Todo
      </a>
      ...
      <div className="mb-3">
        ...
        <div className="d-flex">
          <FormControl className="w-75 me-2" id="wd-todo-description"
      ...
      <div className="mb-3">
        ...
        <div className="d-flex align-items-center">
          <FormCheck className="me-2" id="wd-todo-completed"
            type="checkbox" checked={todo.completed} onChange={(e) =>
              setTodo({ ...todo, completed: e.target.checked })}/>
          <a id="wd-update-todo-completed" className="btn btn-primary"
